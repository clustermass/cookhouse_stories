...
loadRecipeToState(){
  ...
  let difficulty_id = this.props.entities.recipes[this.props.recipeId].difficulty_id
  let cooking_time = this.props.entities.recipes[this.props.recipeId].cooking_time
  let diet_id = this.props.entities.recipes[this.props.recipeId].diet_id
  let cuisine_id = this.props.entities.recipes[this.props.recipeId].cuisine_id
  let main_ingredient_id = this.props.entities.recipes[this.props.recipeId].main_ingredient_id
  let category_id = this.props.entities.recipes[this.props.recipeId].category_id
  let ingredient_ids = this.props.entities.recipes[this.props.recipeId].ingredients_list
  let all_ingredients = {}
  ...
  Object.keys(this.props.entities.recipes[this.props.recipeId].ingredients_measurings).forEach((key)=>{
    amounts[key] = this.props.entities.recipes[this.props.recipeId].ingredients_amounts[key][key]
  })

  let all_steps = {}

  this.props.entities.recipes[this.props.recipeId].steps.forEach((step)=>{
...
this.setState({
  ...
  componentDidMount(){
    ...
    this.props.clearErrors()
    this.props.importRecipe(this.props.recipeId).then(()=>this.loadRecipeToState())
      ...
      <div>
        ...
        <div className="create-page-main-container">
          ...
          <div className="create-page-main-container" >
            ...
            <select value={this.state.difficulty_id} className="create-page-main-diff" onChange={this.update('difficulty_id')}>
          ...
          <div className="create-page-main-container" >
              <span>Cuisine</span>
                <select value={this.state.cuisine_id} className="create-page-main-cuis" onChange={this.update('cuisine_id')}>
          ...
          <div className="create-page-main-container" >
              <span>Diet</span>
                <select value={this.state.diet_id} className="create-page-main-cuis" onChange={this.update('diet_id')} >
          ...
          <div className="create-page-main-container" >
              <span>Category</span>
                <select values={this.state.category_id} className="create-page-main-cuis" onChange={this.update('category_id')} >
                          ...
                          <select className="create-page-main-cuis" onChange={this.update('temp_measuring')} value={this.state.temp_measuring}>
                            ...
                            {Object.values(this.state.all_steps).map((step)=>(
                              ...
                              <div><button className="create-page-main-universal-btn" onClick={()=>this.addNewStep()}>Add new step</button></div>
                                ...
                                <div>
                                  <button style={{cursor:'pointer'}}  className="create-page-main-img-upload" onClick={(e)=> this.submitRecipe(e) }>Update</button>
                                </div>
